...
- **«Добавить с ИИ» (массовый ввод)** — отдельное окно в FAB-меню: опишите сразу несколько операций текстом, голосом или фото чека — ИИ разберёт их в редактируемый список записей, сам определив, что факт, а что план; у каждой строки свои тип, дата, сумма, категория и счёт; записи создаются пакетом после проверки
