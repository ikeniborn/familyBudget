...
- **Товары списком** — кнопка ✨ на странице списков покупок: перечислите товары одной фразой («молоко 2 л, хлеб, десяток яиц») текстом или голосом 🎤, ИИ разберёт названия, количество и группы; позиции добавляются после проверки. В форме одиночного товара — те же 🎤/✨: надиктуйте «молоко 2 литра», поля заполнятся автоматически
