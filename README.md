...
- **Быстрый ввод текстом** — фраза «кофе 350» в форме добавления превращается в заполненный черновик транзакции; создание только после подтверждения. Работает и в форме плана («интернет 900 за октябрь» → плановая запись с периодом)
- **«Добавить с ИИ» (массовый ввод)** — отдельная кнопка ✨ над плавающей кнопкой «+»: опишите сразу несколько операций текстом, голосом или фото чека — ИИ разберёт их в редактируемый список записей, сам определив, что факт, а что план; у каждой строки свои тип, дата, сумма, категория и счёт; записи создаются пакетом после проверки
