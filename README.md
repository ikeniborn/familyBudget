...
- **Товары списком** — кнопка ✨ на странице списков покупок: перечислите товары одной фразой («молоко 2 л, хлеб, десяток яиц»), ИИ разберёт названия, количество и группы; позиции добавляются после проверки
