...
class TestReferenceStatsEndpoint:
    ...
    def test_get_reference_stats_success(self, authenticated_client: TestClient):
    ...
    def test_get_reference_stats_response_structure(self, authenticated_client: TestClient):
