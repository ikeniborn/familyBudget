...
class TestAuthMeEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_auth_me_admin_user_success(self, mock_db_session, mock_user_admin):
    ...
    @pytest.mark.asyncio
    async def test_auth_me_regular_user_success(self, mock_db_session, mock_user_regular):
    ...
    @pytest.mark.asyncio
    async def test_auth_me_user_not_found_in_db(self, mock_db_session):
    ...
    @pytest.mark.asyncio
    async def test_auth_me_database_error(self, mock_db_session):
...
class TestSessionFormatCompatibility:
    ...
    @pytest.mark.asyncio
    async def test_express_session_format_parsing(self, session_store, mock_redis):
    ...
    @pytest.mark.asyncio
    async def test_legacy_session_format_fallback(self, session_store, mock_redis):
    ...
    @pytest.mark.asyncio
    async def test_session_not_found(self, session_store, mock_redis):
    ...
    @pytest.mark.asyncio
    async def test_malformed_session_data(self, session_store, mock_redis):
    ...
    async def test_get_current_user_from_session_no_session_object(self):
        ...
        del mock_request.state.session  # No session attribute
...
class TestSecurityValidation:
    ...
    @pytest.mark.asyncio
    async def test_data_isolation_by_user_id(self, mock_db_session, mock_user_admin):
    ...
    @pytest.mark.asyncio
    async def test_inactive_user_rejection(self, mock_db_session):
