...
class TestCompleteUserJourney:
    ...
    async def test_complete_user_workflow(
        ...
        logger.debug(f"✅ Created expense categories (Living, Groceries, Rent)")
        ...
        logger.debug(f"✅ Added income transaction: $5000.00")
        ...
        logger.debug(f"✅ Added expense transactions (1 rent + 5 groceries)")
        ...
        logger.debug(f"✅ Final state verified - Journey complete!")
...
class TestBudgetPlanningJourney:
    ...
    async def test_budget_planning_workflow(
        ...
        logger.debug(f"✅ Plan vs Fact data retrieved")
...
class TestUserJourneyWithCenters:
    ...
    async def test_user_workflow_with_centers(
        ...
        logger.debug(f"✅ Created 2 Financial Centers (Cash, Bank)")
        ...
        logger.debug(f"✅ Created 2 Cost Centers (Personal, Family)")
        ...
        logger.debug(f"✅ Created 3 categories (Salary, Food, Transport)")
        ...
        logger.debug(f"✅ Added income (Bank + Personal)")
        ...
        logger.debug(f"✅ Added food expense (Cash + Family)")
        ...
        logger.debug(f"✅ Added food expense (Bank + Personal)")
        ...
        logger.debug(f"✅ Added transport expense (Bank + Family)")
        ...
        logger.debug(f"✅ Added transaction without centers (backward compatible)")
        ...
        logger.debug(f"✅ Updated income: Personal → Family budget")
        ...
        logger.debug(f"✅ Category breakdown filtered by Cash ЦФО")
        ...
        logger.debug(f"✅ Category breakdown filtered by Bank ЦФО")
        ...
        logger.debug(f"✅ Category breakdown filtered by Personal МВЗ")
        ...
        logger.debug(f"✅ Category breakdown filtered by Family МВЗ")
        ...
        logger.debug(f"✅ Category breakdown filtered by both Cash ЦФО + Family МВЗ")
        ...
        logger.debug(f"✅ Center distribution verified:")
        ...
        logger.debug(f"✅ Backward compatibility verified (transactions without centers work)")
        ...
        if waterfall_cash.status_code == 200:
            logger.debug(f"✅ Waterfall chart accepts ЦФО filter")
        else:
            logger.debug(f"⚠️  Waterfall filtering by ЦФО not fully implemented")
        ...
        if heatmap_family.status_code == 200:
            logger.debug(f"✅ Heatmap accepts МВЗ filter")
        else:
            logger.debug(f"⚠️  Heatmap filtering by МВЗ not fully implemented")
