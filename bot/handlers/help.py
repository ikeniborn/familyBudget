...
_Создать запись о расходе или доходе_

/today - Статистика за сегодня
_Просмотр доходов и расходов за текущий день_

/stats - Общая статистика
_Просмотр статистики за всё время_
...
• Используйте /add для быстрого добавления расходов
• /today покажет баланс дня
• /stats покажет топ категорий расходов
