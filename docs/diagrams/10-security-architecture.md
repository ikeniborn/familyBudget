...
graph TB
    ...
    subgraph "Layer 2: Authentication"
        L2A[JWT Tokens<br>7 days + 30 days rotation]
    ...
    subgraph "Layer 6: Data Protection"
        L6A[Password Hashing<br>Argon2id memory-hard]
...
flowchart TB
    ...
    ValidatePassword -->|Yes| HashPassword[argon2id.hash<br>memory-hard, GPU-resistant]
    ...
    FetchHash --> CompareHash[argon2id.verify<br>Compare submitted vs stored]
...
- **Memory**: 64 MB per hash (prevents GPU/ASIC attacks)
- **Iterations**: 3 (time cost parameter)
- **Parallelism**: 4 threads
- **Salt**: Automatically generated per password (16 bytes)
