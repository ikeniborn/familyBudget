...
router.get('/budget-vs-actual', getUserId, async (req, res) => {
  try {
...
router.get('/period-summary', getUserId, async (req, res) => {
  try {
    const filters = parseFilters(req.query);
...
router.get('/financial-center-breakdown', getUserId, async (req, res) => {
  try {
    const filters = parseFilters(req.query);
...
router.get('/monthly-trend', getUserId, async (req, res) => {
  try {
    const filters = parseFilters(req.query);
