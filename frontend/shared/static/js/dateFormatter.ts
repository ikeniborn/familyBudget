...
class DateFormatter {
  ...
  static readonly RUSSIAN_MONTHS: readonly string[] = [
   ...
   *
   * @param dateStr - Date string (DD.MM.YYYY or YYYY-MM-DD)
   ...
   *
   * @param isoDate - Date in YYYY-MM-DD format
   * @returns Date in "ДД месяца ГГГГ" format
   *
   * @example
   ...
   *
   * @param displayDate - Date in "ДД месяца ГГГГ" format
   * @returns Date in YYYY-MM-DD format
   *
   * @example
   ...
   *
   * @param dateStr - Date string to validate
   * @returns True if valid "ДД месяца ГГГГ" format
   *
   * @example
   ...
   *
   * @returns Current date with Russian month name
   *
   * @example
   * DateFormatter.todayWithMonthName() // => '27 октября 2025'
   */
  static todayWithMonthName(): string {
    const now = new Date();
   ...
   *
   * @param inputElement - Date input element
   * @param displayDate - Date in DD.MM.YYYY format
   *
   * @example
   ...
   *
   * @param inputElement - Date input element
   * @returns Date in DD.MM.YYYY format or empty string
   *
   * @example
   ...
   *
   * @param utcIsoString - ISO datetime string in UTC (e.g., "2025-12-06T09:30:00Z")
   * @param userTimezone - IANA timezone (e.g., "Europe/Moscow") or null for browser local
   * @returns Formatted local datetime (DD.MM.YYYY HH:MM)
   *
   * @example
   ...
   *
   * @param utcIsoString - ISO datetime string in UTC
   * @param userTimezone - IANA timezone or null for browser local
   * @returns Formatted local date (DD.MM.YYYY)
   *
   * @example
   ...
   *
   * @param userTimezone - IANA timezone or null for browser local
   * @returns Current date in user's timezone (DD.MM.YYYY)
   *
   * @example
   * DateFormatter.todayInTimezone('Europe/Moscow')
   * // => '06.12.2025' (current date in Moscow)
   */
  static todayInTimezone(userTimezone: string | null = null): string {
   ...
   *
   * @param userTimezone - IANA timezone or null for browser local
   * @returns Current date in API format (YYYY-MM-DD)
   *
   * @example
   * DateFormatter.todayISOInTimezone('Europe/Moscow')
   * // => '2025-12-06'
   */
  static todayISOInTimezone(userTimezone: string | null = null): string {
   ...
   *
   * @param localDatetime - Local datetime in "DD.MM.YYYY HH:MM" format
   * @param userTimezone - IANA timezone the input is in
   ...
   * @param date - Date object or ISO string
   * @param userTimezone - IANA timezone or null for browser local
   * @returns Formatted date and time with timezone (DD.MM.YYYY HH:MM (TZ))
   *
   * @example
   ...
   *
   * @returns Browser's timezone (e.g., "Europe/Moscow")
   *
   * @example
