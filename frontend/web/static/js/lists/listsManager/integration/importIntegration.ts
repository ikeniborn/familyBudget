...
// ImportManager is loaded from importManager.js (global)
interface ImportManagerConstructor {
  new (listsManager: any): any;
}

declare global {
  interface Window {
    ImportManager?: ImportManagerConstructor;
  }
}
 ...
 */
export function initializeImportManager(): void {
  ...
  (window as any).importManager = importManager;
