 ...
 */
export function handleItemCreated(item) {
    if (!item || !item.id) {
 ...
 */
export function handleItemUpdated(item) {
    if (!item || !item.id) {
 ...
 */
export function handleItemDeleted(itemId, shoppingListId) {
    if (!itemId) {
 ...
 * @param shoppingListId - Shopping list ID (for filtering)
 */
export function handleItemCompletedToggled(itemId, isCompleted, shoppingListId) {
    if (!itemId) {
...
//# sourceMappingURL=wsEventHandlers.js.map