...
function getTotalNodeCount() {
    ...
    if (!state.hierarchyView)
        return 0;
    const hierarchy = state.hierarchyView.buildHierarchy(state.currentItems, state.stores, state.productGroups);
    let total = 0;
 ...
 */
export function updateHierarchyToggleButton() {
 ...
 */
export function initializeHierarchyView() {
...
//# sourceMappingURL=hierarchyIntegration.js.map