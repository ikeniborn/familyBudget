 ...
 */
export function switchView(viewName, savePreference = true) {
    ...
    if (viewName === 'hierarchy') {
        ...
        if (hierarchyViewContainer)
            hierarchyViewContainer.classList.remove('hidden');
        ...
        if (hierarchyControls)
            hierarchyControls.classList.remove('hidden');
    }
    else {
        ...
        if (hierarchyViewContainer)
            hierarchyViewContainer.classList.add('hidden');
        // Update button styles
        if (tableBtn) {
        ...
        if (hierarchyControls)
            hierarchyControls.classList.add('hidden');
    }
 ...
 */
export function initializeResponsiveView() {
 ...
 */
export function renderShoppingListCards() {
    const state = getState();
 ...
 */
export async function renderDetailView(listId) {
    ...
    if (breadcrumbElement)
        breadcrumbElement.textContent = list.name;
