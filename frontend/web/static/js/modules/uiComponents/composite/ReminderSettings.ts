...
export interface ReminderSettingsProps {
  ...
  message?: string;
  className?: string;
  onChange?: (data: ReminderConfig) => void;
}
...
export class ReminderSettings {
  ...
  private datetimeInput: DateInput;
  private messageInput: TextareaInput;
  private datetimeContainer: HTMLDivElement | null = null;
  private messageContainer: HTMLDivElement | null = null;

  constructor(private props: ReminderSettingsProps) {
   ...
   */
  setValue(data: Partial<ReminderConfig>): void {
