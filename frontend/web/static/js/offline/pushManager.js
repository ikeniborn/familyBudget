...
class PushNotificationManager {
    ...
    async toggleSubscription() {
        ...
        try {
            ...
            if (window.showToast) {
                window.showToast('Ошибка при изменении подписки на уведомления. Попробуйте позже.', 'error');
            }
            return false;
        }
        finally {
    ...
    _updateUI() {
        ...
        if (!this.isSupported) {
            ...
            if (bellTooltip)
                bellTooltip.textContent = 'Push-уведомления не поддерживаются';
            return;
        }
        if (!this.vapidPublicKey) {
            bellBtn.classList.add('hidden');
            if (bellTooltip)
                bellTooltip.textContent = 'Push-уведомления не настроены';
            return;
        }
        ...
        if (bellIcon) {
            if (permission === 'denied') {
                ...
                if (bellTooltip)
                    bellTooltip.textContent = 'Push-уведомления заблокированы';
            }
                ...
                if (bellTooltip)
                    bellTooltip.textContent = 'Push-уведомления включены';
            }
            else {
                ...
                if (bellTooltip)
                    bellTooltip.textContent = 'Включить push-уведомления';
            }
        }
    }
    /**
...
//# sourceMappingURL=pushManager.js.map