...
1. Плейсхолжены всех выпадающих список не отображаютсяпольностью РАсширить по версикале поле /home/ikeniborn/Pictures/Screenshots/Screenshot from 2025-11-19 15-40-12.png
2. ВЫпадающие списки категорий сделаь через подстрочный поиск. ПЕреиспользуй решение для другиз выпадающих спиисков. Например в модальных окнах дорабления транзакии
3. Добавить впалащий списко типа категории. Категории должны фильтрвоаться по выбранно каатегории после выбора типа. Без выбора показываются все категориии.
---
