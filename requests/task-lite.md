...
1. Добавить подстрочний поиск по категориям в интерфейсе.
2. Только фильтрация для уменьшения спика категории в веб.
3. Поиск при вводе каждого символа фильтрует значения в табличной части и скрывает записи которые не подходят
Фильтр должен помочь облегчит ьпоиск категориии для редактирования
---
