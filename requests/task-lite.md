...
Изучи последние изменения в текущей ветке.
Полный деплой с очисткой завершился с ошибкой. 
Првоерь логи запущенных сервисов. 
Определи причину. Внеси изменеиня с код в репозитории.
