...
1. Изучи все изменения в текущей ветке гита проекта
2. Изучи логи контейнеров и делоя.
3. Деплой запрешился неудачно на этапе перезапуска сервисов.
4. Определи причину. Исправь в коде проекта.
---
