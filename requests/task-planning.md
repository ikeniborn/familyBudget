...
1. Изучить шаблон экспорта транзакций из банка тинкофф. /home/ikeniborn/Documents/Project/familyBudget/requests/transactions.csv
2. Добавить импорт шаблона и всатвки на оснвоании шаблона новыхх транзакциий.
