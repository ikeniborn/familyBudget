...
//     this.spreadSheet = new gas.SpreadSheet('portfolio')
//   }

//   getSources() {
//     return new gas.WorkSheet(this.spreadSheet, 'sources').dataValues.reduce(
//       (dim, row) => {
//         const key = new utils.Hash(row[this.head.source.name.idx])
//         if (!dim[key.md5]) {
//           dim[key.md5] = { name: key.stringUpperCase }
//         }
//         return dim
//       },
//       {}
...
//   getCoins() {
//     return new gas.WorkSheet(this.spreadSheet, 'coins').dataValues.reduce(
//       (dim, row) => {
//         const rowKey = row[this.head.coins.rowKey.idx]
//         const rowNkey = row[this.head.coins.rowNkey.idx]
//         const source = row[this.head.coins.source.idx]
//         const name = row[this.head.coins.name.idx]
//         const symbol = row[this.head.coins.symbol.idx]
//         const id = row[this.head.coins.id.idx]
//         if (!dim[rowKey]) {
//           dim[rowKey] = { rowKey, rowNkey, source, name, symbol, id }
//         }
//         return dim
//       },
//       {}
...
//   getHistoricalPrices() {
//     return new gas.WorkSheet(
//       this.spreadSheet,
//       'historicalprices'
//     ).dataValues.reduce((dim, row) => {
//       const rowKey = row[this.head.historicalPrices.rowKey.idx]
//       const rowNkey = row[this.head.historicalPrices.rowNkey.idx]
//       const dateKey = row[this.head.historicalPrices.dateKey.idx]
//       const date = row[this.head.historicalPrices.date.idx]
//       const symbol = row[this.head.historicalPrices.symbol.idx]
//       const pair = row[this.head.historicalPrices.pair.idx]
//       const price = row[this.head.historicalPrices.price.idx]
//       if (!dim[rowKey]) {
//         dim[rowKey] = {
//           rowKey,
//           rowNkey,
...
//     //   {}
//     // )
//     const coins = new Dimension().getCoins()
...
//               ).md5
//               const coinId = coins[rowKey].id
//               if (coinId) {
//                 list[source].push(coinId)
//               }
//             })
//             return list
//           }, {})
...
//   updateCoinsList() {
//     this.spreadSheet.coingecko = new gas.SpreadSheet('coingecko')
...
//   getCoinsId(coin) {
//     const coin_ = new utils.Hash(coin)
//     const coinsListDim = new gas.WorkSheet(this.spreadSheet.portfolio, 'coins')
//       .getValues()
//       .dataValues.reduce((dim, row) => {
//         const rowKey = row[this.head.coinsList.rowKey.idx]
//         if (!dim[rowKey]) {
//           dim[rowKey] = row[this.head.coinsList.id.idx]
//         }
//         return dim
//       }, {})
//     const coinId = this.workSheet.portfolio.price.dataValues
//       .filter(
//         (row) =>
//           new utils.Hash(row[this.head.price.symbol.idx]).md5 === coin_.md5
//       )
//       .reduce((coin, row) => {
//         const name = row[this.head.price.name.idx].toUpperCase()
//         const symbol = row[this.head.price.symbol.idx]
//         const cryptoCompareKey = new utils.Hash('cryptocompare' + name + symbol)
//           .md5
//         const cryptoRankKey = new utils.Hash('cryptorank' + name + symbol).md5
//         const coinMarketCapKey = new utils.Hash('coinMarketCap' + name + symbol)
//           .md5
//         const coinGeckoKey = new utils.Hash('coinGecko' + name + symbol).md5
//         if (!coin[name]) {
//           coin[name] = {
//             name,
//             symbol,
//             cryptoCompareId: coinsListDim[cryptoCompareKey],
//           }
//         }
//         return
//       }, {})
...
//   constructor() {
//     super()
//     this.workSheet.portfolio.allocation = new gas.WorkSheet(
//       this.spreadSheet.portfolio,
//       'allocation'
//     )
//     this.workSheet.portfolio.historicalPrice = new gas.WorkSheet(
//       this.spreadSheet.portfolio,
//       'historicalprices'
//     )
//     this.workSheet.portfolio.transaction = new gas.WorkSheet(
//       this.spreadSheet.portfolio,
//       'transactions'
//     )
//     this.workSheet.portfolio.balance = new gas.WorkSheet(
//       this.spreadSheet.portfolio,
//       'balance'
//     )
//     this.workSheet.portfolio.constractor = new gas.WorkSheet(
//       this.spreadSheet.portfolio,
//       'contractors'
//     )
//   }
