...
id="mobile-balances" маштабировать по размеру по ширине синхронно с id="mobile-stats"
добавить отступ между <span class="text-xs font-bold text-error">-20.6M</span> и <span class="text-[10px] opacity-60">Текущий</span>
сейчас сливаются
---
