...
Добавить пустой блок между для мобильной версии с маленьким экраном с небольшой высобой достаточной для удобной навигации между поиском и списком
<input type="search" class="choices__input choices__input--cloned" autocomplete="off" autocapitalize="off" spellcheck="false" aria-autocomplete="list" aria-label="— Выберите категорию —" placeholder="Поиск категории..." aria-activedescendant="">
и 
<div class="choices__list" role="listbox"><div class="undefined" data-select-text="" data-choice="" data-choice-selectable="" data-id="1" data-value="33" role="option" style="padding-left: 0.75rem;" aria-selected="false">
Для реализации отступа между поискои и выбором категорий для 
https://budget-dev.ikeniborn.ru/
id="modal_add_transaction" 
id="transfer_modal"
id="modal_add_plan" 
https://budget-dev.ikeniborn.ru/facts
id="modal_add_transaction" 
id="transfer_modal"
https://budget-dev.ikeniborn.ru/plan
id="transfer_modal"
id="modal_add_plan" 

объединить кнопки 
<button type="button" class="btn btn-sm btn-warning save-offline-btn btn-disabled" data-form-id="form_modal_add_transaction" data-modal-id="modal_add_transaction" onclick="saveTransactionOffline(this)" title="Доступно только в оффлайн режиме" disabled="">
и 
<button type="submit" class="btn btn-sm btn-success save-upload-btn" title="Сохранить и загрузить на сервер">
В флайн режиме она должна быть оранжевая а в онлайн зеленая.
Функциональной для разнызх режимой сохранить. Назвать должны просто сохранить.
Для мобильнйо версии сжедать кнопку отмета и сохранить шире и больше на 15% для удобства навигации 
---
