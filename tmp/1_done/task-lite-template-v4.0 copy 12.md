...
Проверить как интегирровано обновление sse для главной страницы по всем метрикам и последним записям.
sse ддолжно отобраджать изменения в моменте с наименьшим лагом и без необходимости перезагрузки другим пользваотелей страницы.
Сейчас приходиться перезагрузкать главную страницу чтобы увидеть изменеиня другим пользваотелем.
Т.е. sse не работает как ожидалось 
---
