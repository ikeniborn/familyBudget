...
перенести <span class="text-xs" title="Создано offline">☁️</span> справа от <span class="flex-1 font-medium truncate">Продукты</span>

Убрать из <span class="text-error font-bold whitespace-nowrap">100.00 ₽</span> отображение копеек и валюты
Для расходов и списанй добавлять минут перед суммой, для доходов и пополнения добалять плюч.
