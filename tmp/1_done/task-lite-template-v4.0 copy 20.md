...
При отключении офлайн режима появляются дубли уведомлении по синзронизации 
Првоерь где дублиуется уведомления. Нужно осавить только один вызов уведомленияе что связь восстановлени и сколько синзронизировано 
[OfflineManager] SSE reconnected (online mode)
networkDetector.min.js?v=20251215_1945:1 
[NetworkDetector] Status changed: offline → online
