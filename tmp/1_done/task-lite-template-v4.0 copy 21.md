...
id="welcome-section"
обрабытвать скрыте по тапу на секчию безз использвоаиня onclick="showWelcomeCloseConfirmation()" 
Внизу секчии мелким шрифтом светло серым добавить надпись для скрытия нажмите на секцию привествия
