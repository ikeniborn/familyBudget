...
Кнопку  <button type="button" onclick="modal_add_plan.close()" class="btn btn-sm btn-ghost"> отменить расположить слеваой части модальных форм и добавить текст для мобильнйо 

<button type="button" class="btn btn-sm save-btn" data-form-id="form_modal_add_plan" data-modal-id="modal_add_plan" onclick="savePlan(this)" title="Сохранить на сервер"> добавить текст для мобильнйо версии
