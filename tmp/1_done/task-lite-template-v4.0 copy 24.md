...
id="facts-table-container"
для мобильной версии 
<span class="amount-expense font-bold whitespace-nowrap">-80 ₽</span> убрать валюту 
для десктопной и планшета 
<td class="text-error font-bold">80.00</td> убрать копейки
для мобильной версии скрыть <button class="btn btn-sm btn-error gap-1" id="batch-delete-btn" onclick="batchDelete()" disabled="">🗑️ Удалить выбранные</button>

https://budget-dev.ikeniborn.ru/plan
<div id="facts-table-container" class="min-h-[200px]">
<span class="amount-credit font-bold whitespace-nowrap">+666 ₽</span> убрать валюту дял мобильнйо версии
<td class="text-error font-bold">666.00</td> убрать копейки
для мобильной версии скрыть <button class="btn btn-sm btn-error gap-1" id="batch-delete-btn" onclick="batchDelete()" disabled="">🗑️ Удалить выбранные</button>

https://budget-dev.ikeniborn.ru/facts и https://budget-dev.ikeniborn.ru/plan
id="edit-modal" для мобильнйо версии
Добавить унопку удалить на формы редактирования такак массовго и чекбокса нет в режиме простмотра записей на мобильнйо версии
