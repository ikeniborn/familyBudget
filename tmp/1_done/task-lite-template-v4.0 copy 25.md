...
Sse 
[BudgetSSE] Connection limit reached: 
{total_connections: 5, user_connections: 5, limits: {…}}
_checkConnectionLimit	@	budgetSSEClient.js?v=20251215_2152:80
await in _checkConnectionLimit		
_createConnection	@	budgetSSEClient.js?v=20251215_2152:117
connect	@	budgetSSEClient.js?v=20251215_2152:104
(anonymous)	@	lists:1359
budgetSSEClient.js?v=20251215_2152:119 [BudgetSSE] Limit reached: 5/5
_createConnection	@	budgetSSEClient.js?v=20251215_2152:119
await in _createConnection		
connect	@	budgetSSEClient.js?v=20251215_2152:104
(anonymous)	@	lists:1359
Требуется тщательный анализ пробелму коннекттов sse
Все еще при переклчюенямх между вкладками на нескольких устройсвах срабатывает лмит подклчюений.
Значить соединения не закрываются при переклчюении. Что приводит к отклчюении функции sse
