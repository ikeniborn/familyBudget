...
При отколючении офлацн редима осталасб дублирование уведомление по наличие заисей для ссинзрониазции в одидании для синхронизации. Уведомление синего цвевта.
возможно уведомления дублирутся 
Првоерь уюери дублирвоание уведомлений при отклчюении офлайн редима
---
