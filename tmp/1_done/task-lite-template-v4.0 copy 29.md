...
id="mobile-balances" 
id="desktop-stats"
Изучи тщательно текущее решение по отображению статистики и баланса. 
Сфлормируй 5 вариантов оптимизации визуализации с маштабированием для телефонов, планшетов, десктопов.
Сформируй html на накаждый варниат и сохрани в /home/UF.RT.RU/i.y.tischenko/Документы/Git/familyBudget/tmp/stats
Статистика должна быть полная, эффективно маштабироватсья, без переносов и наползания элементов, имеь четкие границы и отступы, эффетивно испольвоать пространство экрана по вертикале и горизонтале 
