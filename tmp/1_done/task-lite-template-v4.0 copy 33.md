...
Текущее решение по реалиации /home/UF.RT.RU/i.y.tischenko/Документы/Git/familyBudget/tmp/stats/variant1-grid-autofit.html
имеет недостаточ как большой отстум межу строками план и факт. 
Скорректируй шаблок устнани на нем эту проблему пересохрани файл
