...
https://budget-dev.ikeniborn.ru/analytics
class="choices choices-telegram" 
После выбора категорий не применяется фильтр для графиков 
id="chart-plan-fact" 
 id="chart-pie"
 id="chart-heatmap"

 ТАк же нет возможности очистить все выбранные категории чтобы выбрать другие, трубется менять тип категории чтобы очитстиь. 
 Добавить возмоность удалять по каждой каоетгрии в отдельности или очистить все стразу. 
 И визуально работы с мульти выбором выглядит не красиво и недоработанно. Доработай визуал для данного элемента в алалитике. 
