...
id="account-balances" 
Центирровать блоки по середине экрана, сейчас они смещаются влево.
Сейчас они все еще цмещены к левой части и не центирруются по середине 
<div class="balances-grid"> проанализируй динамическое формирование гридов под количество счетов а не станлратное количестов
