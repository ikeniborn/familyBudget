...
Изучи решение добавление before:: для отделение списка 
Добавь тот элемент в конце списка и примени для мобильный версии и интегрируй и для десктопной версии тоже 
