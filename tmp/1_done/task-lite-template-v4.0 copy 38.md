...
Изучить текущую реализацию быстрых сумм для фактических транзакий с расчетом средних показателей
Запланировать удаление функционала с удалиенм элементов на форме и бэкенд ффункционала: джобы, апи, стурктуры в бд.
