...
Сделать блок Аналитика планирования скрываемый. По умолчаниб скрыт. Активировать по тапу на секцию <!-- Plan Analytics Section -->
Сворачивать по тапу на загалоков <h2 class="card-title text-2xl mb-4">📊 Аналитика планирования</h2> 
и добавить внизу секции справа пнопу свернуть.
пример кнопки <button class="btn btn-sm btn-ghost gap-1" onclick="collapseFilters()">
                    ⬆️ Свернуть
                </button>
