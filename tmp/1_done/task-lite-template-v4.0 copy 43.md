...
Для модальных окон проверить корреткность работы фильтрации места затрат на базе проставленного фильтар по счета в стправосинке места затрат. 
Если для места затрат определен конкретный счет то он не должен отобрадаться в модаьном окне после выбора счета 
