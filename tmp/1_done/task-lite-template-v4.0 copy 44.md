...
ПЕренеси метку 
<label for="import-toggle" class="collapse-title text-base sm:text-lg font-medium cursor-pointer flex items-center">
                📥 Импорт <span class="text-xs text-base-content/50 font-normal ml-2">(нажмите чтобы раскрыть)</span>
            </label>
в класс <div class="collapse-content px-2 sm:px-4">
Рассмотри удаление <input type="checkbox" id="import-toggle" onchange="handleImportToggle(this.checked)"> его функциональность не понятна
