...
после авторизации https://budget-dev.ikeniborn.ru/
после деплоя последних изменений на сегодня 
ошибка 
budget-dev.ikeniborn.ru/:176 
        
        
       GET https://budget-dev.ikeniborn.ru/static/css/choices-tailwind.min.css?v=PLACEHOLDER net::ERR_ABORTED 404 (Not Found)
budget-dev.ikeniborn.ru/:191 
        
        
       GET https://budget-dev.ikeniborn.ru/static/js/offline/idb.min.js?v=PLACEHOLDER 404 (Not Found)
budget-dev.ikeniborn.ru/:182 
        
        
       GET https://budget-dev.ikeniborn.ru/shared/static/js/debugLog.min.js?v=PLACEHOLDER net::ERR_ABORTED 404 (Not Found)
budget-dev.ikeniborn.ru/:1 Refused to execute script from 'https://budget-dev.ikeniborn.ru/shared/static/js/debugLog.min.js?v=PLACEHOLDER' because its MIME type ('application/json') is not executable, and strict MIME type checking is enabled.
budget-dev.ikeniborn.ru/:194 
        
        
       GET https://budget-dev.ikeniborn.ru/static/js/offline/conflictResolver.min.js?v=PLACEHOLDER net::ERR_ABORTED 404 (Not Found)
budget-dev.ikeniborn.ru/:198 
        
        
       GET https://budget-dev.ikeniborn.ru/static/js/offline/pushManager.min.js?v=PLACEHOLDER net::ERR_ABORTED 404 (Not Found)
budget-dev.ikeniborn.ru/:1149 
        
        
       GET https://budget-dev.ikeniborn.ru/shared/static/js/budgetShared.min.js?v=PLACEHOLDER net::ERR_ABORTED 404 (Not Found)
budget-dev.ikeniborn.ru/:1 Refused to execute script from 'https://budget-dev.ikeniborn.ru/shared/static/js/budgetShared.min.js?v=PLACEHOLDER' because its MIME type ('application/json') is not executable, and strict MIME type checking is enabled.
budget-dev.ikeniborn.ru/:1155 
        
        
       GET https://budget-dev.ikeniborn.ru/static/css/choices-tailwind.min.css?v=PLACEHOLDER 404 (Not Found)
offlineManager.min.js?v=PLACEHOLDER:20 Uncaught ReferenceError: IndexedDBManager is not defined
    at new OfflineManager (offlineManager.min.js?v=PLACEHOLDER:20:23)
    at (index):4065:33
OfflineManager @ offlineManager.min.js?v=PLACEHOLDER:20
(anonymous) @ (index):4065
(index):1718 Failed to load transaction categories: ReferenceError: BudgetShared is not defined
    at loadTransactionCategories ((index):1703:13)
    at loadCategories ((index):1676:15)
    at HTMLDocument.<anonymous> ((index):1339:5)
loadTransactionCategories @ (index):1718
loadCategories @ (index):1676
(anonymous) @ (index):1339
(index):1350 Uncaught ReferenceError: BudgetShared is not defined
    at HTMLDocument.<anonymous> ((index):1350:31)
(anonymous) @ (index):1350
(index):1754 Failed to load plan categories: ReferenceError: BudgetShared is not defined
    at loadPlanCategories ((index):1741:13)
    at loadCategories ((index):1677:15)
