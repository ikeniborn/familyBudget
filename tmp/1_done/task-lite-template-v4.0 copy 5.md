...
При отключении ручного офлайн редима 
Uncaught (in promise) Error: Sync queue item 2 not found
    at IndexedDBManager.updateSyncQueueItem (idb.min.js?v=20251215_1110:1:10869)
    at async OfflineManager.sync (offlineManager.min.js?v=20251215_1110:1:12057)
    at async OfflineManager._handleManualOfflineExitSync (offlineManager.min.js?v=20251215_1110:1:3299)
    at async offlineManager.min.js?v=20251215_1110:1:1493

Запись попадет в бд но задублированная.
В уведомлении два разных сообщении о синзроании
Записи после отклчюения ручного режима не обновляются после синзронищаци в d="recent-transactions-card"
---
