...
Изучи тщательно кодовую базу проекта. Подготовь граф зависимости
1. функциональности
2. веб
3. ендпоинтов
4. объектов субд
Результатом исследования будет структурированный документа в формате yaml. 
Документа будет использовать при работе с кодовой базой в рамказ изменения или добавления функционала.
Документ должен иметь связи между логическими блоками, функциями, компонентами.
---
