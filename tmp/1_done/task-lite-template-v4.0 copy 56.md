...
/home/UF.RT.RU/i.y.tischenko/Документы/Git/familyBudget/docker-compose.yml
Проверь во всех ли сервисах корректно монтируются минифицированные файлы, а не исходники из репозитори
---
