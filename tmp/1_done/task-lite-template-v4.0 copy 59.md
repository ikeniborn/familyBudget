...
Проверить текущую реализацию быстрых действий. Текущая реализация не соответсвует шаблону 
/home/UF.RT.RU/i.y.tischenko/Документы/Git/familyBudget/tmp/quick/variant-06-mini-cards.html
