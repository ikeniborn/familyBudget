...
Дорабовать мобильную версию https://budget-dev.ikeniborn.ru/
1. сделать <!-- Quick Stats Section --> активную по тапу.  в свернутом виде отображать только доходы и расходы. после тапа и раскрытию показывать все блоки
2. сдлать <!-- Account Balances Section -->активную по тапу. в свернутом виде показывать только два счета с макссимальными оборотом за текущий месяц. При тапе по раскритюи показывать все счета
