...
Карточки баланса все еще используют валюту и не испоьзубтся сокращения. Проанадириуй доработки котоырые ранее были добавлены и почему они не были применены при деплое. 
