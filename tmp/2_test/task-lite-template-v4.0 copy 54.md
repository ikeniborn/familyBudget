...
id="item-modal"
не работает подстрочный поиск при вводе товара id="item-product-name"
Последние изменения как то отразаилсь на функйиоальность.
Проанализировать и восстановить функционал
---
