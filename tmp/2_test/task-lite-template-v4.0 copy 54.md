...
id="item-modal"
не работает подстрочный поиск при вводе товара id="item-product-name" на мобильной версии афона в сафари или хроме или яндекс браузере.
Изучи пробелматику, определи причину. Доработай механизм для мобильнойй версии подтсрочного поиска при вооде товара 
