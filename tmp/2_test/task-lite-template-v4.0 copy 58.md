...
Все примененные доработки в рамках SSE для ios safary не решили проблему. 
Проанадизируй код и логи budget-test. логи запущенных контейнеров /opt/budget + docker compose
По результатам определи пробелму и варианты решения. 
Изучи в интенете подобные ситуации и варианты решения.
