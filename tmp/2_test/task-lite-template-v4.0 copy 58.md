...
Текущая ситуация айфон сафари. 
Открытие или переход по страницам не создается sse соединение.
ПРи отклчюении эрана и включении с разблокировкой соединение сразу открывается и рабоатет.
Исследуй тщаттельно этот паттерн. Проанадиируй текущую реализацию 
Исправь пробелму соедениения sse при открытиии страницы и переклчениях. 
