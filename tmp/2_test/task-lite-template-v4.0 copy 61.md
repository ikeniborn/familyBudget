...
При аналите вкладки devtools network наблюдаеются вызовы как сервис воркера так и с бэкенда.
Это кажется избыточным. Это корреткная архитектура? 
Если нет то проработай логику работы и взаимедействия сервис воркера и бэкенда
