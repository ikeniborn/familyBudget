...
Изучи id="item-modal"
id="hierarchy-view"  
<div class="overflow-x-auto shadow-lg rounded-lg hidden sm:block" id="desktop-table-container">
проанализиру стурктуру отобрадение товаров. При добалении одного товара она дублируется в отобрадении.
Актуально для мобильной и декстопной версии.
При удалении одной записи удаляется и вторая
