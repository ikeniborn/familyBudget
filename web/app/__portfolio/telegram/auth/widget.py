...
class TelegramLoginWidget:
    ...
    def __init__(self, telegram_login: str, size: Size = Size.MEDIUM, user_photo: bool = False, corner_radius: int = 20, access_write: bool = True):
        self.telegram_login = telegram_login
        self.corner_radius = corner_radius
        self.size = size
        self.user_photo = user_photo
        self.access_write = access_write
        self.start_script = "<script async src=" '"https://telegram.org/js/telegram-widget.js?22"'
    ...
    def callback_telegram_login_widget(self, func: str, arg: str = "") -> str:
        ...
        params = self._generate_params(self.telegram_login, self.size, self.corner_radius, self.user_photo, self.access_write)
        return (
            f"{self.start_script} "
    ...
    def _generate_params(self, telegram_login: str, size: Size, corner_radius: int = None, user_photo: bool = False, access_write: bool = True):
        """
        ...
        data_radius = f'data-radius="{corner_radius}"' if isinstance(corner_radius, int) else ""
