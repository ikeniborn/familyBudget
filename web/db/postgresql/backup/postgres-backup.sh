...
if [[ -f $BACKUP_POSTGRES_CATALOG/$BACKUP_POSTGRES_NAME ]]; then
  sudo rm $BACKUP_POSTGRES_CATALOG/$BACKUP_POSTGRES_NAME 
fi
...
if [[ -f $BACKUP_POSTGRES_CATALOG/$BACKUP_POSTGRES_NAME ]]; then
  ...
  if [[ -f $BACKUP_POSTGRES_CATALOG/$BACKUP_POSTGRES_NAME_OLD ]]; then
    sudo rm $BACKUP_POSTGRES_CATALOG/$BACKUP_POSTGRES_NAME_OLD 
